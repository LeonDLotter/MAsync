...
plt.tight_layout()
plt.savefig(join(sdir, 'fig4a.pdf'), transparent=False, bbox_inches='tight')
...
plt.savefig(join(sdir, 'fig4b.pdf'), transparent=True, bbox_inches='tight')
...
devel['age'] = [l.split('_')[0].capitalize() for l in devel.cLabel]
...
plt.savefig(join(sdir, 'fig4c.pdf'), transparent=True, bbox_inches='tight')
