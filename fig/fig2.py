...
plt.savefig(join(sdir, 'fig2ac.pdf'), transparent=True, bbox_inches='tight')
...
plt.savefig(join(sdir, 'fig2b1.pdf'), dpi=400, bbox_inches='tight', transparent='true')
...
plt.savefig(join(sdir, 'fig2b2.pdf'), bbox_inches='tight', transparent='true')
...
plt.savefig(join(sdir, 'fig2d1.pdf'), transparent=True, bbox_inches='tight')
...
plt.savefig(join(sdir, 'fig2d2.pdf'), transparent=True, bbox_inches='tight') 
